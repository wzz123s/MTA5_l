...
- 2026-09-10 04:2x **L3 阈值验证**：校准后 incl current＋EA idx329 全 74,071 行 mismatch=0 → 22,568 已归零（非预计）。详见问题记录 §二十三「T1 第一轮公平基线重跑」
- 2026-09-10 04:3x **EA 64 笔逐笔明细**：[T1_EA匹配64笔_逐笔计算_20260910.csv](黄金/30m2H策略/data/validation/mainline_v337_tester_20260907/T1_EA匹配64笔_逐笔计算_20260910.csv)（组级 64 笔）＋[T1_EA匹配192子仓_逐行明细_20260910.csv](黄金/30m2H策略/data/validation/mainline_v337_tester_20260907/T1_EA匹配192子仓_逐行明细_20260910.csv)；合计净利 +5,684.03 USD，盈利组 27/亏损组 37。详见问题记录 §二十三「T1 第一轮公平基线重跑」
- 2026-09-10 04:5x **D+A 审查＋全流程复算**：[T1_D+A_过拟合审查_20260910.md](黄金/30m2H策略/data/validation/mainline_v337_tester_20260907/T1_D+A_过拟合审查_20260910.md)——全流程 payoff 2.69/样本外 2.57，未稳定达 3:1，建议暂不落地。详见问题记录 §二十三「T1 第一轮公平基线重跑」
- 2026-09-10 05:0x **completed-only+A walk-forward**：[T1_completedOnly_A_walkforward_20260910.md](黄金/30m2H策略/data/validation/mainline_v337_tester_20260907/T1_completedOnly_A_walkforward_20260910.md)——收益集中 2025，其余 OOS 年负，规则不稳定，不采用。详见问题记录 §二十三「T1 第一轮公平基线重跑」
- 2026-09-10 05:1x **A-only R 扫描＋Regime 初探**：[T1_AonlyR与Regime初探_20260910.md](黄金/30m2H策略/data/validation/mainline_v337_tester_20260907/T1_AonlyR与Regime初探_20260910.md)——R35 盈亏比3.78但训练PF低；H2 bias55>5% 组明显亏损（PF0.19）值得全流程验证。详见问题记录 §二十三「T1 第一轮公平基线重跑」
- 2026-09-10 09:3x **v3.38 regime 参数固化写盘**：正常退出（09:32:00）后 `chart06.chr` 写入 `InpUseRegimeCap=true`、`InpRegimeCapPct=5.0`（含 Regime 分组头，文件 340,384→340,538B）；重启（09:32:09，PID 43596）后 8/8 expert loaded（journal 09:32:11–12）、主 EA v3.38 init 复现 `[Regime] TRUE/cap 5.0%`；`read_chart_params()` 已可读出两键 → 参数不再依赖 ex5 默认值。详见问题记录 §二十三「T1 第一轮公平基线重跑」
- 2026-09-10 05:2x **Regime |Bias55|≤5% 全流程 WF**：[T1_regimeBias5_walkforward_20260910.md](黄金/30m2H策略/data/validation/mainline_v337_tester_20260907/T1_regimeBias5_walkforward_20260910.md)——full PF3.11/payoff3.34、test PF6.31/payoff4.34、train转正；比 D/A 稳健，继续阈值敏感性。详见问题记录 §二十三「T1 第一轮公平基线重跑」
- 2026-09-10 05:5x **Regime 阈值敏感性 4.5/5.0/5.5%**：[T1_regime_threshold_sens_20260910.md](黄金/30m2H策略/data/validation/mainline_v337_tester_20260907/T1_regime_threshold_sens_20260910.md)——三档各走完整管线重建；5.0% 仍为峰值（full PF3.11/payoff3.34、test PF6.31/payoff4.34）；4.5% 更薄样本；5.5% 放开 5–5.5% 边际组后 payoff 降至3.06/PF2.59、2026 PF 掉至2.31 → 收口 5.0%。详见问题记录 §二十三「T1 第一轮公平基线重跑」
- 2026-09-10 06:5x **主线 EA v3.38 regime 改造＋Tester 取证**：[T1_regime_v338_EA_取证报告_20260910.md](黄金/30m2H策略/data/validation/mainline_v337_tester_20260907/T1_regime_v338_EA_取证报告_20260910.md)——唯一入场路径（Layer1/Layer3 通过后）加 completed |H2 Bias55|≤5% gate（默认开，可关）；gate-off 复跑零回归，gate-on 全窗 55 组 vs Python expected 58、matched 52，缺 6（2 收盘不可成交伪差＋4 v3.37 已登记）+多 3（v3.37 同族），无新增残差族；live 根目录 ex5 未部署。详见问题记录 §二十三「T1 第一轮公平基线重跑」
- 2026-09-10 07:0x **主线 v3.38 实盘自动加载完成**：旧 root ex5 备份 `.v337_m15fix_backup_20260910`（150,354B/`55b25330`）→ 投 v3.38（160,560B/`24f18d30`）→ 终端正常退出重启，04:03:36 chart06 加载 `30m x 2H EA v3.38`＋`[Regime] InpUseRegimeCap=TRUE cap=5.0%`＋LIVE TRADING；8/8 EA initialized、无 failed、chart_layout 8 图无双挂；回滚见 问题记录 §二十三「T1 第一轮公平基线重跑」
- 2026-09-10 07:2x **ABC regime 移植试验（不采用）**：[T1_ABC_regime_cap5_试验报告_20260910.md](黄金/30m2H策略/data/validation/30m2H_ABC_regime_cap5_20260910/T1_ABC_regime_cap5_试验报告_20260910.md)——Python ABC 同源管线 baseline vs |Bias55|≤5%：EA窗 2025-26 n80/+2852/PF2.35（1%终值914.7）→ n59/+1561/PF2.05（664.7）；高 bias(>5%) 21 组 +1291/PF3.04 是 ABC 盈利核心（2026 19 组+1191），与主线高 bias 亏损相反 → **不移植，regime 仅主线专属**。详见问题记录 §二十三「T1 第一轮公平基线重跑」
