...
$Strategy = "1H_M30_4H"
$EAName = "1H_M30_4H_ABC_EA"

$SourceMq5 = Join-Path $Here "$EAName.mq5"
$SourceEx5 = Join-Path $Here "$EAName.ex5"
$SourceSet = Join-Path $Here "1H_M30_4H_ABC_SimDeployment_EA.set"
...
Copy-Item -LiteralPath $SourceSet -Destination (Join-Path $PresetsDir "1H_M30_4H_ABC_SimDeployment_EA.set") -Force
