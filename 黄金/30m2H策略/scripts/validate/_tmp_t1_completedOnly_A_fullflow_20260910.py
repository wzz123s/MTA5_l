# -*- coding: utf-8 -*-
"""Combo: completed-only Layer1 + Stage1/2 R up (3/2.5/6), full-flow OOS."""
...
OUT_LED = os.path.join(DST, "30m2H_python_completedOnly_A_expected_trade_ledger_mp3.csv")
...
print("building completed-only + A expected ledger...", flush=True)
