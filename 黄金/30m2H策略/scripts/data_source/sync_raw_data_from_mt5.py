# -*- coding: utf-8 -*-
"""Pull 30m2H strategy-dedicated raw data directly from MT5 (M15/M30/H2)."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--from", dest="date_from", required=True, help="UTC start date, e.g. 2018-01-01.")
    parser.add_argument("--to", dest="date_to", required=True, help="UTC end date, e.g. 2026-08-11.")
