# -*- coding: utf-8 -*-
"""Diagnose unmatched causes from metadata-fixed shift90 + ClosePos retry outputs."""
...
base.MAPPED_DIR = DATA_DIR / "validation" / "mapped_trade_alignment_shift90_metadatafix_close_retry_20260714"
base.DYNAMIC_DIR = DATA_DIR / "validation" / "dynamic_risk_alignment_shift90_metadatafix_close_retry_20260714"
base.OUT_DIR = DATA_DIR / "validation" / "unmatched_signal_cause_shift90_metadatafix_close_retry_20260714"
...
def load_python_layers_metadatafix(source: str):
...
base.load_python_layers = load_python_layers_metadatafix
