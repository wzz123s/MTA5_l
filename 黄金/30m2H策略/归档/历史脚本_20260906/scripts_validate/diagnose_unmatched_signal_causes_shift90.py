# -*- coding: utf-8 -*-
"""Diagnose unmatched causes from the shift90 mapped trade snapshot."""
...
base.OUT_DIR = DATA_DIR / "validation" / "unmatched_signal_cause_shift90_20260713"


def load_python_layers_shift90(source: str):
    ...
    accepted = base.prepare_signal_layer(base.read_csv(signal_dir / "候选信号_Layer1_Layer2通过.csv"), "accepted", source)
    picked = base.prepare_signal_layer(base.read_csv(signal_dir / "最终信号_Layer3入选.csv"), "picked", source)
...
base.load_python_layers = load_python_layers_shift90
