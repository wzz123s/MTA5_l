...
input bool    InpSimMode    = true;          // true=signal only, false=LIVE trading
...
string g_m15_entry_diag_path = "30m2H_strategy_m15_entry_diag.csv";
...
{
   Print("========================================");
   Print("  30m x 2H EA v3.26 SIM-ONLY - Initializing (batch Python SMMA + M15 runtime fixes, 2026-07-10)");
   Print("========================================");
#ifdef SIM_ONLY_BUILD
   if(!InpSimMode)
   {
      Print("  [SIM-ONLY GUARD] InpSimMode=false is not allowed in this build. Initialization aborted before trading setup.");
      return INIT_FAILED;
   }
   Print("  [SIM-ONLY GUARD] active: SIMULATION mode is required; live order placement is blocked by init guard.");
#endif
