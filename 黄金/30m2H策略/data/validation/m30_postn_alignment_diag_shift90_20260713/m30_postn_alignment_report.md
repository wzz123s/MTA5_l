...
| python_mt5  | mt5_m30_postn    | reliable_matched | 0             |            0 |      5 |
| python_mt5  | mt5_m30_postn    | reliable_matched | <=30          |           -1 |      1 |
| python_mt5  | mt5_m30_postn    | unmatched        | 0             |            0 |      3 |
| python_mt5  | mt5_m30_postn    | unmatched        | none          |              |     15 |
| python_mt5  | python_m30_postn | matched          | 0             |            0 |      5 |
| python_mt5  | python_m30_postn | matched          | <=30          |            1 |      3 |
| python_mt5  | python_m30_postn | matched          | none          |              |      1 |
| python_mt5  | python_m30_postn | unmatched        | 0             |            0 |      3 |
| python_mt5  | python_m30_postn | unmatched        | <=30          |            1 |      3 |
| python_mt5  | python_m30_postn | unmatched        | <=60          |            2 |      5 |
| python_mt5  | python_m30_postn | unmatched        | none          |              |      5 |
...
|:------------|:-------------------------------------|:----------------------------|:--------------|-------------:|-------:|
| python_mt5  | stage_execution_diff_or_family_drift | family_drift                | none          |              |      7 |
| python_mt5  | trigger_family_drift                 | family_drift                | none          |              |      4 |
| python_mt5  | mapping_conflict_or_profit_diff      | executed_nearby             | 0             |            0 |      3 |
| python_mt5  | mapping_conflict_or_profit_diff      | executed_nearby             | none          |              |      2 |
| python_mt5  | layer3_reject                        | accepted_only_layer3_reject | none          |              |      1 |
