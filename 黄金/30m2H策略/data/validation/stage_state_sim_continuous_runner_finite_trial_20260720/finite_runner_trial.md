...
- cycle `1`: status `pass`, monitor `pass`, signal rows `6`, ledger rows `0`, positions `0`, orders `0`
- cycle `2`: status `pass`, monitor `pass`, signal rows `6`, ledger rows `0`, positions `0`, orders `0`
- cycle `3`: status `pass`, monitor `pass`, signal rows `6`, ledger rows `0`, positions `0`, orders `0`
