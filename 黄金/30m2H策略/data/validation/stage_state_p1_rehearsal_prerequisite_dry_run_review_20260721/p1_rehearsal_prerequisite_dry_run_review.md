...
- planned_steps_reviewed: `18`
- blocker_failure_count: `0`
- ready_to_live_trade: `False`

## Checks

- `decision_status_live_blocked`: `True` - p1_rehearsal_dry_run_planned_live_blocked
- `expected_p1_rehearsal_count_is_3`: `True` - expected=3
- `plan_count_matches_expected`: `True` - plan=3 expected=3
- `expected_keys_match_plan`: `True` - missing=[] extra=[]
- `planned_steps_present`: `True` - steps=18
