...
|:------------|:-----------------|:-------------------------------------|-------:|
| python_mt5  | mt5_unmatched    | mapping_conflict_or_profit_diff      |     14 |
| python_mt5  | mt5_unmatched    | stage_execution_diff_or_family_drift |     14 |
...
| python_mt5  | python_unmatched | unique_match_conflict                |     32 |
| python_mt5  | python_unmatched | mt5_family_or_time_drift             |     22 |
...
| python_mt5  | mt5_unmatched    | M30 CLOSE        | cross         | mapping_conflict_or_profit_diff      |      4 |
| python_mt5  | mt5_unmatched    | M30 CLOSE        | cross         | stage_execution_diff_or_family_drift |      1 |
| python_mt5  | mt5_unmatched    | M30 CLOSE        | post_n        | stage_execution_diff_or_family_drift |      7 |
| python_mt5  | mt5_unmatched    | M30 CLOSE        | post_n        | mapping_conflict_or_profit_diff      |      5 |
...
| python_mt5  | mt5_unmatched    | M30 CLOSE        | pre_cross     | stage_execution_diff_or_family_drift |      3 |
...
| python_mt5  | python_unmatched | M15 SLOT1        | post_n        | mt5_family_or_time_drift             |     12 |
| python_mt5  | python_unmatched | M15 SLOT1        | post_n        | unique_match_conflict                |     11 |
| python_mt5  | python_unmatched | M15 SLOT1        | pre_cross     | mt5_family_or_time_drift             |      4 |
...
| python_mt5  | python_unmatched | M30 CLOSE        | cross         | unique_match_conflict                |      3 |
