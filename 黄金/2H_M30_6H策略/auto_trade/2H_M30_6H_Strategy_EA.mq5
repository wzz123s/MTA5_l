//+------------------------------------------------------------------+
//|                                     2H_M30_6H_Strategy_EA.mq5    |
//|                                                          Codex    |
//|                                  2H / M30 / 6H baseline profile  |
//|                                  Dedicated defaults derived from  |
//|                                  2H_M30_6H validation bundle     |
...
//--- Input parameters
input group "=== Account ==="
input ulong   InpMagic      = 322025;      // Magic Number
...
input bool    InpExportCSV    = true;       // Export per-bar signals to CSV (2H_M30_6H_strategy_signals_export.csv)
input bool    InpExportTradeLedger = true;  // Export per-stage trade ledger (2H_M30_6H_strategy_trade_ledger.csv)
...
//--- CSV export (v3.21)
int g_csv_handle = INVALID_HANDLE;   // 2H_M30_6H_strategy_signals_export.csv file handle
string g_csv_path = "2H_M30_6H_strategy_signals_export.csv";
int g_ledger_handle = INVALID_HANDLE;
string g_ledger_path = "2H_M30_6H_strategy_trade_ledger.csv";
string g_deal_history_path = "2H_M30_6H_strategy_deal_history.csv";
int g_stage_price_diag_handle = INVALID_HANDLE;
string g_stage_price_diag_path = "2H_M30_6H_strategy_stage_price_diag.csv";
int g_m15_entry_diag_handle = INVALID_HANDLE;
string g_m15_entry_diag_path = "2H_M30_6H_strategy_m15_entry_diag.csv";
...
ulong Execute(string direction, double entry, double stop, double lot, int stage = 0)
{
   ...
   string this_comm  = (stage >= 1 && stage <= 3)
                       ? ("2H_M30_6H_S" + IntegerToString(stage))
                       : "2H_M30_6H";
