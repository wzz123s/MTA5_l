...
$SourceMq5 = Join-Path $Here "2H_M30_6H_Strategy_EA.mq5"
$SourceSet = Join-Path $Here "2H_M30_6H_Strategy_EA.set"
...
$DestMq5 = Join-Path $ExpertsDir "2H_M30_6H_Strategy_EA.mq5"
$DestSet = Join-Path $TesterDir "2H_M30_6H_Strategy_EA.set"
...
Write-Host "Open MetaEditor, compile 2H_M30_6H_Strategy_EA.mq5, then run MT5 Strategy Tester with 2H_M30_6H_Strategy_EA.set."
