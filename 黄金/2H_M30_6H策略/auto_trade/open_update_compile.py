...
def main():
    ...
    # 关闭当前文件 (Ctrl+F4)
    print("关闭当前文件 (Ctrl+F4)...")
    send_keys("^{F4}")
    time.sleep(2)

    # 从导航器打开2H_M30_6H_CurrentCandidate_EA.mq5
    print("从导航器打开目标文件...")
    ...
    print(f"当前窗口: {me_win.window_text()}")
