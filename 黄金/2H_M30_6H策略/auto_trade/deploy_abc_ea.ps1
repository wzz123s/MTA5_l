...
$SourceSet = Join-Path $Here "2H_M30_6H_ABC_SimDeployment_EA.set"
...
Copy-Item -LiteralPath $SourceSet -Destination (Join-Path $PresetsDir "2H_M30_6H_ABC_SimDeployment_EA.set") -Force
